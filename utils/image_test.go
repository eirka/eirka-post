...
func TestGetStatsBadSize(t *testing.T) {
	...
	err := img.getStats()
	if assert.Error(t, err, "An error was expected") {
		assert.Contains(t, err, errors.New("Image size too large"), "Error should match")
	}
...
func TestGetStatsBadMin(t *testing.T) {
	...
	err := img.getStats()
	if assert.Error(t, err, "An error was expected") {
		assert.Contains(t, err, errors.New("Image width too small"), "Error should match")
	}
...
func TestGetStatsBadMax(t *testing.T) {
	...
	err := img.getStats()
	if assert.Error(t, err, "An error was expected") {
		assert.Contains(t, err, errors.New("Image width too large"), "Error should match")
	}
